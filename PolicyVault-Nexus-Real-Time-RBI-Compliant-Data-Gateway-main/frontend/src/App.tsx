...
import VaultViewLanding from './pages/user-dashboard/components/VaultView';
import CanaraBank from './pages/admin-dashboard/components/AdminLoginDetector';
import PasswordVaultView from './pages/admin-dashboard/components/password-vault/[consent_id]';
// import PasswordVaultView from './pages/admin-dashboard/components/PasswordView';
function App() {
...
/>
      ...
      <Route path="/vaultview" element={<VaultViewLanding />}/>
      <Route path="/administrator" element={<CanaraBank />}/>
      {/* <Route path="/password-vault" element={<PasswordVaultView/>}/> */}
      <Route path="/password-vault/:consent_id" element={<PasswordVaultView />} />
      <Route 
            path="/admin/*" 
            element={
              <ProtectedRoute>
